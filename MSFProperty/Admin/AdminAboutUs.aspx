...
<script>
    function UploadComplete() {
        ...
        const scr = $('#uploadedImageUrl').val();

        $('#aboutimagePreview').attr('src', scr);
        $('#AboutImage').val(null);
        $('#FileUpload1').val(null);
        
        $('#useUploadedFileAboutUs').addClass('hidden');
        $('.useUploadedFileAboutUs').addClass('hidden');
    }
</script>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="ShowFolder" runat="server" Text="Use File From folder" OnClientClick=" event.preventDefault();$('#useUploadedFileAboutUs').removeClass('hidden');"/>
                            <asp:Panel ID="useUploadedFileAboutUs" GroupingText="Use File From folder" CssClass="hidden" runat="server">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="Button1" runat="server" Text="Use File From folder" OnClientClick=" event.preventDefault();$('.useUploadedFileAboutUs').removeClass('hidden');"/>
                            <asp:Panel  GroupingText="Use File From folder" CssClass="hidden useUploadedFileAboutUs" runat="server">
