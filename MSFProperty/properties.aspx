        ...
        <div class="tab">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div id="Amenities" class="tabcontent">
                  <div><h1>Bedrooms :  <%= GetBedrooms() %> </h1></div>
                    <div><h1>Bath facilities : <%= GetCount() %></h1></div>
                    <asp:Repeater ID="bathRepeater" runat="server">
                        <ItemTemplate>
                            <div><h3> <%# Container.DataItem %> </h3></div>
                        </ItemTemplate>
                    </asp:Repeater>  
                    <div><h1>Pets allowed :<%=GetPetsAllowed() %> </h1></div>
                    <div><h1>General : </h1> 
                ...
                <div id="Pricing" class="tabcontent">
                    <div><h1>Available from :<%=GetAvaiable() %> </h1></div>
                    <div><h1>Deposit :<%=GetDeposit() %> </h1></div>
                    <div><h1>Monthly Rent :<%=GetRentPrice() %> </h1></div>
