                ...
                <ItemTemplate>
                    <li class="wpg-list-villas-inset-item clear-both-fix">
                        <div class="wpg-lvi-box span-table">
                          ...
                          <%--    = mainImage,
                         = bedrooms,
                         = CreateCommaSeperatedList(amenities),
                         = bathType,
                         = pets,
                        ...
                        Area = FullAdress.Area--%>
                            ...
                            <div class="span-table-cell vertical-align-middle text-align-center wpg-lvi-box-side">
                                <ul class="clear-both-fix">
                                    ...
                                    <li class="wpg-ico-bath wpg-ico"><strong>Washing Facilities</strong> <span>Bath</span><small><%# Eval("BathType") %></small></li>
                        ...
                        <div class="wpg-lvi-sub-box">
                            ...
                            <p></p>
                            <p  style="width: 100%; overflow: hidden; text-overflow: ellipsis; height: 32%;"> <%# getContents(Convert.ToInt32(Eval("ID"))) %> </p>
